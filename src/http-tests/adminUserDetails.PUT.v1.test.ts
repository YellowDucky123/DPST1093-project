...
describe("test for adminUserDetails.PUT.v1", ()=>{
  let details: {token? :string, email? : string, nameFirst?: string, nameLast?: string} = {email : "test@email.com", nameFirst: "name", nameLast:"test"}
  ...
  test('test for change email', ()=>{
    ...
    let token = JSON.parse(res.body as string)
